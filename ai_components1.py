...
def report(list, score, total):
    ...
    template = f"""You are provided with a list of questions {{question}} and list of coreesponding answers{list[1]} marked .
    Suggest if any reading or clarity is required in concepts. dont write anythign unnecesary"""
